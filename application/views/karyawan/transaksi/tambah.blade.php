...
@section('content')
	...
	<div class="form-group">
		...
		<button type="submit" class='btn btn-info'>Tambah produk <span class="glyphicon glyphicon-plus"></span> </button>
		<a href="reset" class='btn btn-danger'>Batalkan transaksi <span class="glyphicon glyphicon-remove"></span> </a>
		</form>
    <?php
    $no = 1;
    $harga = 0;
    ...
    <table class="table table-border">
        ...
        <?php $harga += $p->jumlah_beli*$p->harga; ?>
    ...
    <a class="btn btn-success" href="simpan" <?php if(count($produk_beli) == 0) echo "disabled"; ?>>Simpan transaksi <span class="glyphicon glyphicon-download-alt"></span> </a>
    <a class="btn btn-primary" target="_blank" href="simpancetak" <?php if(count($produk_beli) == 0) echo "disabled"; ?>>Simpan dan Cetak Faktur <span class="glyphicon glyphicon-cloud-download"></span> </a>
@endsection
